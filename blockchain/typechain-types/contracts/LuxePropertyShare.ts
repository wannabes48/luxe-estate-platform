...
export interface LuxePropertyShareInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SHARES"
      | "allowance"
  ...
  encodeFunctionData(
    functionFragment: "propertyDatabaseId",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface LuxePropertyShare extends BaseContract {
  connect(runner?: ContractRunner | null): LuxePropertyShare;
  waitForDeployment(): Promise<this>;

  interface: LuxePropertyShareInterface;
  ...
  propertyDatabaseId: TypedContractMethod<[], [string], "view">;

  renounceOwnership: TypedContractMethod<[], [void], "nonpayable">;

  sharesMinted: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "propertyDatabaseId"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "renounceOwnership"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "sharesMinted"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  filters: {
    ...
    "DividendDistributed(uint256)": TypedContractEvent<
      DividendDistributedEvent.InputTuple,
      DividendDistributedEvent.OutputTuple,
      DividendDistributedEvent.OutputObject
    >;
    ...
    "SharesPurchased(address,uint256)": TypedContractEvent<
      SharesPurchasedEvent.InputTuple,
      SharesPurchasedEvent.OutputTuple,
      SharesPurchasedEvent.OutputObject
    >;
