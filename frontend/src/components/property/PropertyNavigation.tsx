...
export default function PropertyNavigation({ prevSlug, nextSlug }: NavProps) {
  return (
    <section className="border-t border-stone-200 bg-white overflow-hidden relative z-50">
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        {/* Previous Property */}
        <Link 
          href={prevSlug ? `/properties/${prevSlug}` : '#'} 
          className={`group relative p-16 md:p-24 border-b md:border-b-0 md:border-r border-stone-100 transition-colors duration-700 hover:bg-stone-50 ${!prevSlug && 'pointer-events-none opacity-50'}`}
        >
          <div className="relative z-10 flex items-center gap-8">
             ...
             <div>
               ...
               <h4 className="font-serif text-3xl">Retrospective</h4>
             </div>
          </div>
        </Link>
        ...
        {/* Next Property */}
        <Link 
          href={nextSlug ? `/properties/${nextSlug}` : '#'} 
          className={`group relative p-16 md:p-24 transition-colors duration-700 hover:bg-[#FCFAFA] ${!nextSlug && 'pointer-events-none opacity-50'}`}
        >
          <div className="relative z-10 flex items-center justify-end gap-8 text-right">
             <div>
               ...
               <h4 className="font-serif text-3xl">The Narrative</h4>
             </div>
