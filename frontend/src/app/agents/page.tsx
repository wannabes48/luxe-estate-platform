                  ...
                  <div key={agent.id || i} className="group">
                    <Link href={`/agents/${agent.id}`}>
                      <div className="cursor-pointer">
                        ...
                        <h2 className="font-serif text-5xl mb-3 text-[#0D0D0D] group-hover:italic group-hover:text-[#E91E63] transition-all duration-300">{agent.name}</h2>
                      </div>
                    </Link>
                    ...
                    <div className="flex flex-col gap-5 border-t border-stone-100 pt-8">
                      ...
                      <div className="mt-6">
                        <Link href={`/agents/${agent.id}`} className="text-[10px] uppercase tracking-widest text-[#E91E63] border-b border-[#E91E63] pb-1 hover:text-[#0D0D0D] hover:border-black transition-colors">
                          View Full Profile & Portfolio &rarr;
                        </Link>
                      </div>
                    </div>
                  </div>
